class Pixel {
  ...
  class PixelCanvas extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._parent = this.parentElement || document.body;
    ...
    handleEvent(event) {
      ...
      if (action) this.handleAnimation(action);
    }
    ...
    init() {
      ...
      this.pixels = [];
      for (let x = 0; x < rect.width; x += this.gap) {
        for (let y = 0; y < rect.height; y += this.gap) {
